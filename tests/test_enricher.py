...
from scraper.core.enricher import DetailPageEnricher, DetailParser, NullEnricher
from scraper.core.fetcher import FetchResponse


class _StubMiddleware:
    """Records fetched URLs and returns canned HTML."""
...
class TestDetailPageEnricher:
    async def test_fetches_url_and_parses(self):
        ...
        enricher = DetailPageEnricher(mw, _EchoParser())  # type: ignore[arg-type]
    ...
    async def test_custom_url_key(self):
        ...
        enricher = DetailPageEnricher(mw, _EchoParser(), url_key="detail_url")  # type: ignore[arg-type]
